    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-6 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">Panel Administrasi Sistem</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-field">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input 
                            type="checkbox" 
                            name="remember" 
                            class="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500 dark:border-slate-600 dark:bg-slate-700"
                        >
                ...
                <div class="mt-4 flex flex-col items-center gap-2 text-sm">
                    @if(Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-red-600 hover:text-red-700 dark:text-red-400">
                            Lupa password?
                        </a>
                    @endif
