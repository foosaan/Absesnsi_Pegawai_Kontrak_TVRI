<x-app-layout title="Pengajuan Cuti">
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <a href="{{ route('user.leaves.create') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">{{ $leave->total_days }} hari</span>
                    </div>
                ...
                <div class="mb-3">
                    <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white">{{ $leave->start_date->format('d M Y') }}</span>
                        <i class="fas fa-arrow-right text-gray-400"></i>
                        <span class="font-medium text-gray-900 dark:text-white">{{ $leave->end_date->format('d M Y') }}</span>
                    </div>
                </div>
